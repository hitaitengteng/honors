...
\documentclass{frontiersENGsuppmat} % for Engineering articles
%\documentclass{frontiersSCNSsuppmat} % for Science articles
%\documentclass{frontiersHLTHsuppmat} % for Health articles
%\documentclass{frontiersFPHYsuppmat} % for Physics articles
